...
def test_production_area_gives_reported_operating_activity() -> None:
    assert (
        classify_activity_row(
            {
                "zone_id": "Z1",
                "zone_name": "A",
                "under_production_area_acres": 1,
                "allotted_area_acres": 10,
                "industrial_area_acres": 20,
            }
        )
...
def test_commercial_production_status_gives_reported_operating_activity() -> None:
    assert (
        classify_activity_row({"zone_id": "Z1", "zone_name": "A", "operational_status": "Commercial Production"})
        == "reported_operating_activity"
    )
